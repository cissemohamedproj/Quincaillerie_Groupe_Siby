...
// Route pour récupérer tous les approvisionnements avec Pagignation
router.get(
  '/getPagignationApprovisonements',
  approvisonementController.getPagignationApprovisonements
);
